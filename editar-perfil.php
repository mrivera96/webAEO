        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formularioEditar" role="form" method="post" action="actualizarPerfil.php" target="formDestination">
                        ...
                        <button class="form-control" name="guardar" id="guardar" type="submit" style="width:100%; background-color:#005662; color:white;" ><span class="glyphicon glyphicon-floppy-disk"></span>  Guardar</button>
                        <br>
...
<script src="js/EdicionPerfil.js"></script>
