...
if (isset($_GET["id_contacto"])) {
    ...
    $query = "SELECT imagen,nombre_organizacion,numero_fijo,numero_movil,e_mail,direccion,descripcion_organizacion,latitud,longitud FROM contactos WHERE id_contacto=?";
